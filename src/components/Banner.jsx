...
const Banner = () => {
  return (
    <section className="bg-gray-50 py-18 md:h-[500px] px-6 ">
      <Container classes="flex flex-col-reverse md:flex-row items-center md:justify-between relative z-10 ">
        ...
        <div className="w-full md:max-w-[60%] md:h-[75vh] relative md:absolute -top-52 right-0">
          <img
          ...
          <picture>
            ...
            <img
              ...
              class="absolute z-5 right-0 top-0"
            />
          </picture>
        </div>
      </Container>
